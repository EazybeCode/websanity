    ...
    return [
      {
        ...
        headers: [
          ...
          { key: "Content-Security-Policy", value: "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://www.googletagmanager.com https://www.google-analytics.com https://cdn.jsdelivr.net; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; img-src 'self' data: https: blob:; font-src 'self' https://fonts.gstatic.com; connect-src 'self' https://www.google-analytics.com https://api.hubspot.com https://api.hsforms.com https://*.sanity.io https://cdn.sanity.io https://api.eazybe.com https://eazybe.com https://ipapi.co https://api.country.is; frame-src 'self' https://www.youtube.com https://player.vimeo.com https://calendly.com; script-src-elem 'self' 'unsafe-inline' https://www.googletagmanager.com https://www.google-analytics.com https://cdn.jsdelivr.net https://assets.calendly.com; object-src 'none'; base-uri 'self'; form-action 'self'" },
        ],
      },
