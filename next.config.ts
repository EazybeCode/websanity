    ...
    return [
      {
        ...
        headers: [
          ...
          { key: "Content-Security-Policy", value: "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://www.googletagmanager.com https://www.google-analytics.com https://www.google.com https://*.google.com https://cdn.jsdelivr.net; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; img-src 'self' data: https: blob:; font-src 'self' https://fonts.gstatic.com; connect-src 'self' https://www.google-analytics.com https://www.google.com https://*.google.com https://*.google.co.in https://googleads.g.doubleclick.net https://stats.g.doubleclick.net https://analytics.google.com https://connect.facebook.net https://www.clarity.ms https://v.clarity.ms https://sc.lfeeder.com https://cdn.leadinfo.net https://*.leadinfo.net https://api.leadinfo.com https://app.factors.ai https://api.factors.ai https://snap.licdn.com https://px.ads.linkedin.com https://js.hs-scripts.com https://api.hubspot.com https://api.hsforms.com https://forms.hscollectedforms.net https://*.sanity.io https://cdn.sanity.io https://api.eazybe.com https://eazybe.com https://ipapi.co https://api.country.is; frame-src 'self' https://www.youtube.com https://player.vimeo.com https://calendly.com; script-src-elem 'self' 'unsafe-inline' https://www.googletagmanager.com https://www.google-analytics.com https://www.google.com https://*.google.com https://googleads.g.doubleclick.net https://cdn.jsdelivr.net https://assets.calendly.com https://connect.facebook.net https://snap.licdn.com https://www.clarity.ms https://scripts.clarity.ms https://sc.lfeeder.com https://cdn.leadinfo.net https://app.factors.ai https://js.hs-scripts.com https://js.hs-analytics.net https://js.hsadspixel.net https://js.hscollectedforms.net https://js.hs-banner.com; object-src 'none'; base-uri 'self'; form-action 'self'" },
        ],
      },
