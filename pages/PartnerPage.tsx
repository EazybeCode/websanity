...
const LazyFooter = React.lazy(() =>
  import('../components/footer/ChunkyFooter').then(m => ({ default: m.ChunkyFooter }))
)
...
const ScrollReveal: React.FC<{ children: React.ReactNode; delay?: number; className?: string }> = ({ children, delay = 0, className = '' }) => {
  ...
  useEffect(() => {
    ...
    const currentElement = document.querySelector(`[data-reveal="${delay}"]`)
    ...
    <div className="min-h-screen bg-slate-950">
      ...
      <section className="relative pt-24 pb-16 lg:pt-32 lg:pb-24 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            ...
            >
              <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-slate-800/50 border border-slate-700 text-slate-300 text-sm">
      ...
      <section className="py-20 lg:py-28 bg-gradient-to-b from-slate-950 to-slate-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <ScrollReveal delay={7} className="text-center mt-12">
            <a
              href="#apply"
              className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-cyan-600 to-blue-600 text-white font-semibold rounded-full hover:from-cyan-500 hover:to-blue-500 transition-all duration-300"
            >
              Ready to unlock these partner benefits?
              <ArrowRight size={18} />
            </a>
          </ScrollReveal>
        </div>
      ...
      <section className="py-20 lg:py-28 bg-gradient-to-b from-slate-900 to-slate-950">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <ScrollReveal delay={6} className="text-center mt-10">
            <a
              href="#apply"
              className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-cyan-600 to-blue-600 text-white font-semibold rounded-full hover:from-cyan-500 hover:to-blue-500 transition-all duration-300"
            >
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <ScrollReveal delay={2}>
            <form className="space-y-6 p-8 rounded-2xl bg-slate-800/50 border border-slate-700/50">
              ...
              <button
                type="submit"
                className="w-full inline-flex items-center justify-center gap-2 px-8 py-4 bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 text-white font-semibold rounded-xl transition-all duration-300"
              >
      ...
      {/* Footer */}
      <React.Suspense fallback={<div className="h-64 bg-slate-900" />}>
        <LazyFooter />
      </React.Suspense>
    </div>
  )
