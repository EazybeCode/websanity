...
// Portuguese (BR) slug of the WhatsApp pricing calculator. Each locale has its
// own translated slug (WA_PRICING_PATH_BY_LOCALE); requesting this slug under
// any other locale redirects to that locale's URL.
const PAGE_LOCALE = 'br'
