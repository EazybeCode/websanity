...
export default async function BlogListingPage({
  ...
  // Add JSON-LD schemas for Brazilian Portuguese blog page - only BreadcrumbList
  if (locale === 'br') {
    const brSchemas = [
      {
  ...
  // Add JSON-LD schemas for Spanish blog page - only BreadcrumbList
  if (locale === 'es') {
    const esSchemas = [
      {
        "@context": "https://schema.org/",
  ...
  // Add JSON-LD schemas for Turkish blog page - only BreadcrumbList
  if (locale === 'tr') {
    const trSchemas = [
      {
        "@context": "https://schema.org/",
