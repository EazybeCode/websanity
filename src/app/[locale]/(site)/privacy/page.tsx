...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: getCanonicalOnly(locale, '/privacy'),
  }
}
...
export default async function PrivacyPage({
  ...
  return (
    <div >
      {/* Hero Section */}
      <section className="page-hero" data-tone="dark" style={{paddingBottom: 30}}>
        <div className="container" style={{maxWidth: 820}}>
          <div style={{display: "flex", alignItems: "center", gap: 14, marginBottom: 20}}>
            <div style={{width: 52, height: 52, borderRadius: 14, background: "linear-gradient(135deg, color-mix(in oklab, var(--accent-a) 28%, var(--paper)), color-mix(in oklab, var(--accent-b) 18%, var(--paper)))", border: "1px solid color-mix(in oklab, var(--accent-a) 35%, var(--line))", display: "flex", alignItems: "center", justifyContent: "center", color: "var(--accent-ink)"}}>
              <Shield className="w-6 h-6" />
            </div>
            <div>
              <h1 style={{fontFamily: "var(--f-display)", fontSize: 40, fontWeight: 400, letterSpacing: "-0.02em", color: "var(--ink)"}}>
          ...
          <p style={{fontFamily: "var(--f-mono)", fontSize: 12, color: "var(--accent-ink)", letterSpacing: "0.12em", textTransform: "uppercase", marginTop: 8, marginBottom: 14}}>
            {isBr ? 'Revisado 2026' : isEs ? 'Revisado 2026' : isTr ? '2026 Revize Edildi' : 'Revised 2026'}
          </p>
          <p style={{color: "var(--ink-3)", fontSize: 16, lineHeight: 1.6}}>
            {isBr
        ...
        <div className="container" style={{maxWidth: 820}}>
          ...
          <div className="mb-12">
            <h2 style={{fontFamily: "var(--f-display)", fontSize: 24, fontWeight: 400, color: "var(--ink)", marginBottom: 16, display: "flex", alignItems: "center", gap: 12, letterSpacing: "-0.01em"}}>
              <span style={{display: "inline-flex", alignItems: "center", justifyContent: "center", width: 30, height: 30, borderRadius: 8, background: "color-mix(in oklab, var(--accent-a) 18%, var(--paper))", color: "var(--accent-ink)", fontFamily: "var(--f-mono)", fontSize: 13, fontWeight: 600, border: "1px solid color-mix(in oklab, var(--accent-a) 30%, var(--line))"}}>1</span>
          ...
          <div className="mb-12">
            <h2 style={{fontFamily: "var(--f-display)", fontSize: 24, fontWeight: 400, color: "var(--ink)", marginBottom: 16, display: "flex", alignItems: "center", gap: 12, letterSpacing: "-0.01em"}}>
              <span style={{display: "inline-flex", alignItems: "center", justifyContent: "center", width: 30, height: 30, borderRadius: 8, background: "color-mix(in oklab, var(--accent-a) 18%, var(--paper))", color: "var(--accent-ink)", fontFamily: "var(--f-mono)", fontSize: 13, fontWeight: 600, border: "1px solid color-mix(in oklab, var(--accent-a) 30%, var(--line))"}}>2</span>
            ...
            <div style={{paddingLeft: 42, color: "var(--ink-2)", fontSize: 16, lineHeight: 1.7}}>
              <p>
                ...
                <a href="https://developers.google.com/terms/api-services-user-data-policy" target="_blank" rel="noopener noreferrer" style={{color: "var(--accent-ink)", borderBottom: "1px solid color-mix(in oklab, var(--accent-ink) 40%, transparent)"}}>
          ...
          <div className="mb-12">
            <h2 style={{fontFamily: "var(--f-display)", fontSize: 24, fontWeight: 400, color: "var(--ink)", marginBottom: 16, display: "flex", alignItems: "center", gap: 12, letterSpacing: "-0.01em"}}>
              <span style={{display: "inline-flex", alignItems: "center", justifyContent: "center", width: 30, height: 30, borderRadius: 8, background: "color-mix(in oklab, var(--accent-a) 18%, var(--paper))", color: "var(--accent-ink)", fontFamily: "var(--f-mono)", fontSize: 13, fontWeight: 600, border: "1px solid color-mix(in oklab, var(--accent-a) 30%, var(--line))"}}>3</span>
          ...
          <div className="mb-12">
            <h2 style={{fontFamily: "var(--f-display)", fontSize: 24, fontWeight: 400, color: "var(--ink)", marginBottom: 16, display: "flex", alignItems: "center", gap: 12, letterSpacing: "-0.01em"}}>
              <span style={{display: "inline-flex", alignItems: "center", justifyContent: "center", width: 30, height: 30, borderRadius: 8, background: "color-mix(in oklab, var(--accent-a) 18%, var(--paper))", color: "var(--accent-ink)", fontFamily: "var(--f-mono)", fontSize: 13, fontWeight: 600, border: "1px solid color-mix(in oklab, var(--accent-a) 30%, var(--line))"}}>4</span>
          ...
          <div className="mb-12">
            <h2 style={{fontFamily: "var(--f-display)", fontSize: 24, fontWeight: 400, color: "var(--ink)", marginBottom: 16, display: "flex", alignItems: "center", gap: 12, letterSpacing: "-0.01em"}}>
              <span style={{display: "inline-flex", alignItems: "center", justifyContent: "center", width: 30, height: 30, borderRadius: 8, background: "color-mix(in oklab, var(--accent-a) 18%, var(--paper))", color: "var(--accent-ink)", fontFamily: "var(--f-mono)", fontSize: 13, fontWeight: 600, border: "1px solid color-mix(in oklab, var(--accent-a) 30%, var(--line))"}}>5</span>
            ...
            <div style={{paddingLeft: 42, color: "var(--ink-2)", fontSize: 16, lineHeight: 1.7}}>
              <ul style={{paddingLeft: 18, marginTop: 8, marginBottom: 16, color: "var(--ink-3)", lineHeight: 1.7}}>
                <li><strong style={{color: "var(--ink)"}}>{isBr ? 'Sem Venda de Dados:' : isEs ? 'Sin Venta de Datos:' : isTr ? 'Veri Satisi Yok:' : 'No Sale of Data:'}</strong> {isBr ? 'Nao vendemos, alugamos ou trocamos seus dados pessoais com terceiros.' : isEs ? 'No vendemos, alquilamos ni intercambiamos sus datos personales con terceros.' : isTr ? 'Kisisel verilerinizi ucuncu taraflara satmiyor, kiralamiyor veya takas etmiyoruz.' : 'We do not sell, rent, or trade your personal data to third parties.'}</li>
                <li><strong style={{color: "var(--ink)"}}>{isBr ? 'Integracoes de Terceiros:' : isEs ? 'Integraciones de Terceros:' : isTr ? 'Ucuncu Tarafa Entegrasyonlar:' : 'Third-Party Integrations:'}</strong> {isBr ? 'Os dados sao compartilhados apenas com servicos de terceiros que voce autoriza explicitamente.' : isEs ? 'Los datos solo se comparten con servicios de terceros que usted autoriza explicitamente.' : isTr ? 'Veriler yalnizca acikca izin verdiginiz ucuncu taraf hizmetlerle paylasilir.' : 'Data is only shared with third-party services (like your CRM provider or payment processor like Stripe) that you explicitly authorize.'}</li>
                <li><strong style={{color: "var(--ink)"}}>{isBr ? 'Uso Limitado:' : isEs ? 'Uso Limitado:' : isTr ? 'Sinirli Kullanim:' : 'Limited Use:'}</strong> {isBr ? 'Nao usamos seus dados para publicidade, analise de credito ou qualquer finalidade alem de fornecer o servico Eazybe.' : isEs ? 'No utilizamos sus datos para publicidad, solvencia crediticia o ningun proposito fuera de proporcionar el servicio Eazybe.' : isTr ? 'Verilerinizi Eazybe hizmetini saglamanin disinda reklam, kredi durumu veya herhangi bir amacla kullanmiyoruz.' : 'We do not use your data for advertising, creditworthiness, or any purpose outside of providing the Eazybe service.'}</li>
              </ul>
            </div>
          </div>
          ...
          <div className="mb-12">
            <h2 style={{fontFamily: "var(--f-display)", fontSize: 24, fontWeight: 400, color: "var(--ink)", marginBottom: 16, display: "flex", alignItems: "center", gap: 12, letterSpacing: "-0.01em"}}>
              <span style={{display: "inline-flex", alignItems: "center", justifyContent: "center", width: 30, height: 30, borderRadius: 8, background: "color-mix(in oklab, var(--accent-a) 18%, var(--paper))", color: "var(--accent-ink)", fontFamily: "var(--f-mono)", fontSize: 13, fontWeight: 600, border: "1px solid color-mix(in oklab, var(--accent-a) 30%, var(--line))"}}>6</span>
            ...
            <div style={{paddingLeft: 42, color: "var(--ink-2)", fontSize: 16, lineHeight: 1.7}}>
              ...
              <ul style={{paddingLeft: 18, marginTop: 8, marginBottom: 16, color: "var(--ink-3)", lineHeight: 1.7}}>
                <li><strong style={{color: "var(--ink)"}}>{isBr ? 'Desinstalando:' : isEs ? 'Desinstalando:' : isTr ? 'Kaldirarak:' : 'Uninstalling:'}</strong> {isBr ? 'Voce pode parar a coleta de dados desinstalando a Extensao do Chrome.' : isEs ? 'Puede detener la recopilacion de datos desinstalando la Extension de Chrome.' : isTr ? 'Chrome Uzantisini kaldirarak veri toplamayi durdurabilirsiniz.' : 'You can stop data collection by uninstalling the Chrome Extension.'}</li>
                <li><strong style={{color: "var(--ink)"}}>{isBr ? 'Solicitacao de Exclusao:' : isEs ? 'Solicitud de Eliminacion:' : isTr ? 'Silme Talebi:' : 'Deletion Request:'}</strong> {isBr ? 'Para excluir permanentemente sua conta e todos os dados associados, entre em contato em ' : isEs ? 'Para eliminar permanentemente su cuenta y todos los datos asociados, contactenos en ' : isTr ? 'Hesabinizi ve tum iliskili verileri kalici olarak silmek icin ' : 'To permanently delete your account and all associated data from our databases, please contact us at '}<a href="mailto:hey@eazybe.com" style={{color: "var(--accent-ink)", borderBottom: "1px solid color-mix(in oklab, var(--accent-ink) 40%, transparent)"}}>hey@eazybe.com</a>. {isBr ? 'As solicitacoes sao processadas em ate 5 dias uteis.' : isEs ? 'Las solicitudes se procesan dentro de 5 dias habiles.' : isTr ? 'Talepler 5 is gunu icinde islenir.' : 'Requests are processed within 5 business days.'}</li>
              </ul>
            </div>
          </div>
          ...
          <div style={{marginBottom: 32, padding: 24, background: "var(--bg-2)", border: "1px solid var(--line)", borderRadius: 14}}>
            ...
            <div style={{color: "var(--ink-2)", fontSize: 16, lineHeight: 1.7}}>
              <p><strong style={{color: "var(--ink)"}}>Eazybe, Inc.</strong></p>
              <p>8, The Green STE B, Dover, Delaware - 19901</p>
              <p>{isBr ? 'E-mail: ' : isEs ? 'Correo electronico: ' : isTr ? 'E-posta: ' : 'Email: '}<a href="mailto:hey@eazybe.com" style={{color: "var(--accent-ink)", borderBottom: "1px solid color-mix(in oklab, var(--accent-ink) 40%, transparent)"}}>hey@eazybe.com</a></p>
            </div>
          </div>
