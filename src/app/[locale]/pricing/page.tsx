    ...
    if (locale === 'es') {
      return [
        ...
        },
        {
          ...
          image: 'https://eazybe.com/logo.png',
          description:
            'Eazybe ayuda a los equipos de ventas a automatizar conversaciones de WhatsApp con agentes de IA, calificar leads, detectar oportunidades estancadas y sincronizar chats con CRM como HubSpot, Zoho, Salesforce y Google Sheets.',
          foundingDate: '2022-09-13',
          founder: {
            '@type': 'Person',
            name: 'Sagar Dewan',
    ...
    if (locale === 'tr') {
      return [
        ...
        },
        {
          ...
          image: 'https://eazybe.com/logo.png',
          description:
            'Eazybe, satış ekiplerinin WhatsApp konuşmalarını yapay zeka ajanları ile otomatikleştirmesine, lead\'leri nitelendirmesine, soğuyan fırsatları tespit etmesine ve sohbetleri HubSpot, Zoho, Salesforce ve Google Sheets gibi CRM platformlarıyla senkronize etmesine yardımcı olur.',
          foundingDate: '2022-09-13',
          founder: {
            '@type': 'Person',
            name: 'Sagar Dewan',
