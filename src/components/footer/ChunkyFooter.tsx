...
export const ChunkyFooter: React.FC = () => {
  ...
  const faqData = {
    en: [
      ...
      { question: 'How does the free trial work?', answer: 'You can start with our 4-day free trial with no credit card required. After the trial, you can choose a plan that fits your needs - from individual users to enterprise teams.' },
    ...
    br: [
      ...
      { question: 'Como funciona o teste gratuito?', answer: 'Voce pode comecar com nosso teste gratuito de 4 dias sem necessidade de cartao de credito. Apos o teste, voce pode escolher um plano que atenda as suas necessidades - de usuarios individuais a equipes empresariais.' },
    ...
    es: [
      ...
      { question: 'Como funciona la prueba gratuita?', answer: 'Puede comenzar con nuestra prueba gratuita de 4 dias sin necesidad de tarjeta de credito. Despues de la prueba, puede elegir un plan que se ajuste a sus necesidades, desde usuarios individuales hasta equipos empresariales.' },
