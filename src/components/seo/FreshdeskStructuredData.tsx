/**
 * JSON-LD structured data for Freshdesk WhatsApp Integration page
 * Includes: FAQPage, BreadcrumbList, WebPage, Product, HowTo
 */

export function FreshdeskStructuredData() {
  const faqSchema = {
    '@context': 'https://schema.org',
    '@type': 'FAQPage',
    '@id': 'https://eazybe.com/freshdesk-whatsapp-integration/#faq',
    mainEntity: [
      {
        '@type': 'Question',
      ...
      {
        '@type': 'Question',
        name: 'Which Freshdesk objects can I associate WhatsApp conversations with?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Most teams associate WhatsApp conversations with contacts and tickets to track context across the sales pipeline. The best mapping depends on your Freshdesk workflow.'
        }
      }
    ]
  }
  ...
  const webPageSchema = {
    ...
    name: 'Freshdesk WhatsApp Integration | Sync WhatsApp + Freshdesk',
  ...
  return (
    <>
      ...
      <script
        type="application/ld+json"
        data-schema="breadcrumb-freshdesk"
        dangerouslySetInnerHTML={{ __html: JSON.stringify(breadcrumbSchema) }}
      />
      <script
        type="application/ld+json"
        data-schema="webpage-freshdesk"
