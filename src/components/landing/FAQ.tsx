...
const ITEMS: { q: string; a: string }[] = [
  { q: 'What is a WhatsApp AI Agent and how does it work?', a: 'A WhatsApp AI Agent is an autonomous AI program that reads, understands and replies to WhatsApp messages on behalf of a business. It uses large language models to qualify leads, answer support tickets, sync chats to your CRM and trigger workflows in real time. Eazybe installs as a Chrome extension on WhatsApp Web and works in 10 minutes with no code required.' },
  ...
  { q: 'Do I need the WhatsApp Business API to use an AI agent?', a: 'No, Eazybe works with Personal WhatsApp and the WhatsApp Business App and the WhatsApp Cloud API simultaneously. No number switching, no migration, no IT project.' },
  ...
  { q: 'Which CRMs does the Eazybe WhatsApp AI Agent integrate with?', a: 'HubSpot, Salesforce, Zoho CRM, Pipedrive, Bitrix24, LeadSquared, Freshworks, Google Sheet and any other system via webhooks or REST API. One-click OAuth, bi-directional sync, no manual data entry.' },
    ...
    <section className="section" id="faq" style={{ paddingTop: 60 }}>
      <div className="container">
        <div className="sec-head centered reveal">
          ...
          <h2>All Your <em>WhatsApp AI Agent</em> Questions, Answered</h2>
