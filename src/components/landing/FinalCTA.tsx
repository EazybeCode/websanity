  ...
  return (
    <section className="final-cta" data-tone="dark">
      <div className="container">
        <h2 className="reveal">Your WhatsApp Team <em>Finally With An AI Brain.</em></h2>
        <p className="sub reveal">WhatsApp Agents that know your CRM, read your chats and sell like your best reps 24/7.</p>
        ...
        <div className="final-cta-trust">
          <div className="final-cta-trust-line">
            ...
            <span className="fct-item">2,000+ sales teams</span>
            <span className="fct-sep" />
            <span className="fct-item">40+ countries</span>
            <span className="fct-sep" />
            <span className="fct-item">
          ...
          <div className="final-cta-flags">
            ...
            <span className="fct-flag-more">+30 more</span>
          </div>
        </div>
      </div>
    </section>
