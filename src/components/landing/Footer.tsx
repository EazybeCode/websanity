...
const COLS: { titleKey: string; items: { nameKey?: string; literalName?: string; brand?: string; href: string; badgeKey?: string }[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { nameKey: 'itemAllTools', href: '/tools' },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { nameKey: 'itemContact', href: 'https://wa.me/916364346419' },
    ],
  },
]
          ...
          <div className="footer-brand">
            ...
            <div className="footer-socials">
              ...
              <div className="footer-socials-icons">
                <a href="https://x.com/EazybeHQ" aria-label="Twitter / X" target="_blank" rel="noopener noreferrer">
