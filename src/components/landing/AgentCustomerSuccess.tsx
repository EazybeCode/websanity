          ...
          <div className="visual reveal">
            <div className="chat">
              ...
              <div className="chat-body">
                <div className="msg"><span className="sm-av sm-av-user"><img src="https://i.pravatar.cc/96?img=33" alt="Customer asking a support question on WhatsApp" loading="lazy"/></span><div className="bub">{t('chatMsg1')}</div></div>
                <div className="msg ai"><span className="sm-av">CS</span><div className="bub">{t('chatBot1')}</div></div>
                <div className="msg"><span className="sm-av sm-av-user"><img src="https://i.pravatar.cc/96?img=33" alt="Customer asking a support question on WhatsApp" loading="lazy"/></span><div className="bub">{t('chatMsg2')}</div></div>
