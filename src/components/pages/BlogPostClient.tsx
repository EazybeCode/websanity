    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-br from-brand-blue/10 to-brand-cyan/10 border border-brand-cyan/20 rounded-2xl p-5 shadow-xl">
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 w-full text-center bg-brand-blue hover:bg-brand-blue/90 text-white font-semibold py-3 px-6 rounded-xl transition-colors"
        >
