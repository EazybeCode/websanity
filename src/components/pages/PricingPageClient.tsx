...
const defaultPricingPlans: PricingPlan[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { text: 'AI agents charged per reply', included: true, highlight: true },
...
const FALLBACK_BY_LOCALE: Record<string, LocaleFallback> = {
  ...
  es: {
    ...
    featureLabels: {
      ...
      'AI agents charged per reply': 'Los agentes de IA se cobran por respuesta',
  ...
  br: {
    ...
    featureLabels: {
      ...
      'AI agents': 'Agentes de IA',
      'AI agents charged per reply': 'Agentes de IA cobrados por resposta',
  ...
  tr: {
    ...
    featureLabels: {
      ...
      'AI agents charged per reply': 'AI ajanları yanıt başına ücretlendirilir',
