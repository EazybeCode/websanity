...
const SectionKicker: React.FC<{ label: string; color?: string }> = ({ label, color = 'blue' }) => {
  ...
  return (
    <span className={`inline-flex items-center gap-2 font-mono text-xs font-bold uppercase tracking-wider ${colorMap[color] || colorMap.blue} bg-slate-900/80 backdrop-blur px-4 py-2 rounded-full border`}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <div className="mt-12 flex flex-col sm:flex-row items-center justify-center gap-6">
            <button
              ...
              className="bg-blue-600 hover:bg-blue-700 text-white font-bold px-8 py-4 rounded-xl shadow-lg shadow-blue-500/25 flex items-center gap-2 group transition-all cursor-pointer"
            >
              Install for Free <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
            </button>
            <button className="bg-transparent border border-slate-700 hover:border-slate-500 text-slate-300 font-bold px-8 py-4 rounded-xl transition-colors cursor-pointer">
              See Team Inbox
            </button>
          </div>
      ...
      <section className="py-24 bg-slate-950 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <button className="mt-10 bg-transparent border border-slate-700 hover:border-slate-500 text-white font-bold px-6 py-2.5 rounded-xl flex items-center gap-2 group transition-all cursor-pointer">
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={i} className="bg-slate-800/50 border border-slate-700 rounded-xl overflow-hidden">
                <button className="w-full p-6 text-left flex items-center justify-between group cursor-pointer">
