/**
 * Dialling codes for the lead form's phone field.
 *
 * Brazil leads the list because this campaign targets BR and it is the
 * default; everything after it is alphabetical.
 *
 * Flags are derived from the ISO code rather than stored, so there is no
 * second list to keep in sync and no 200 hardcoded emoji to get wrong.
 */
