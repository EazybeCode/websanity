  ...
  en: {
    ...
    story: {
      ...
      paragraphs: [
        ...
        'Today, teams use Eazybe to manage WhatsApp conversations, track leads, automate follow-ups, and keep their CRM updated automatically with tools like <strong class="text-white">HubSpot, Zoho and Salesforce</strong> along with spreadsheets like <strong class="text-white">Google Sheets</strong>.',
  ...
  br: {
    ...
    story: {
      ...
      paragraphs: [
        ...
        'Hoje, as equipes usam a Eazybe para gerenciar conversas no WhatsApp, rastrear leads, automatizar follow-ups e manter seu CRM atualizado automaticamente com ferramentas como <strong class="text-white">HubSpot, Zoho e Salesforce</strong>, al\u00e9m de planilhas como <strong class="text-white">Google Sheets</strong>.',
  ...
  es: {
    ...
    story: {
      ...
      paragraphs: [
        ...
        'Hoy, los equipos usan Eazybe para gestionar conversaciones de WhatsApp, rastrear leads, automatizar seguimientos y mantener su CRM actualizado autom\u00e1ticamente con herramientas como <strong class="text-white">HubSpot, Zoho y Salesforce</strong>, junto con hojas de c\u00e1lculo como <strong class="text-white">Google Sheets</strong>.',
  ...
  tr: {
    ...
    story: {
      ...
      paragraphs: [
        ...
        'Bug\u00fcn ekipler Eazybe\u2019yi WhatsApp g\u00f6r\u00fc\u015fmelerini y\u00f6netmek, m\u00fc\u015fteri adaylar\u0131n\u0131 takip etmek, takipleri otomatikle\u015ftirmek ve <strong class="text-white">HubSpot, Zoho ve Salesforce</strong> gibi ara\u00e7larla ve <strong class="text-white">Google Sheets</strong> gibi elektronik tablolarla CRM\u2019lerini otomatik olarak g\u00fcncel tutmak i\u00e7in kullan\u0131yor.',
