      ...
      <AnimatePresence>
        {isExpanded && (
          <motion.div
            ...
            className="fixed left-8 w-[340px] z-40 bottom-8"
          >
      ...
      <AnimatePresence>
        {!isExpanded && (
          <motion.button
            ...
            transition={{ duration: 0.3, ease: 'easeOut' }}
            onClick={handleToggle}
            className="fixed left-0 top-1/2 -translate-y-1/2 z-40 flex flex-col items-center gap-2 bg-brand-blue hover:bg-blue-700 text-white p-4 rounded-r-xl shadow-glow-blue transition-all duration-200 hover:pl-5"
