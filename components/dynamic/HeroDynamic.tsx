        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="max-w-2xl">
            ...
            <h1 className="text-5xl lg:text-7xl font-sans font-semibold tracking-tight text-brand-ink mb-8 leading-[1.05]">
              {data.headline} {data.headlineHighlight && (
                <span className="text-brand-blue">{data.headlineHighlight}</span>
              )}
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-start mb-12">
              {data.primaryCta && (
                <Button variant="primary" size="lg" icon={data.primaryCta.showIcon ? <ArrowRight size={18} /> : undefined}>
            ...
            {data.socialProof && (
              <div className="flex items-center gap-2 text-sm text-slate-500 font-medium">
                ...
                <span className="ml-2">{data.socialProof}</span>
              </div>
            )}
          </div>
