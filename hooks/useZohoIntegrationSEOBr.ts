    ...
    if (isBrZohoPage) {
      ...
      const faqSchema = {
        ...
        "mainEntity": [
          {
            "@type": "Question",
            "name": "Como conecto WhatsApp ao Zoho CRM?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Instale o Eazybe e conecte sua conta do Zoho. O Eazybe sincroniza os chats do WhatsApp para o Zoho para que as conversas e o contexto do cliente permaneçam vinculados aos registros certos do CRM."
            }
          },
          {
            "@type": "Question",
            ...
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Sim. O Eazybe pode sincronizar conversas do WhatsApp para o Zoho automaticamente, reduzindo copiar/colar manual e mantendo a atividade de vendas atualizada."
            }
          },
          {
            "@type": "Question",
            "name": "Vários membros da equipe podem usar uma caixa de entrada compartilhada com Zoho + WhatsApp?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Sim. O Eazybe suporta fluxos de trabalho de caixa de entrada compartilhada para que as equipes possam colaborar em leads do WhatsApp enquanto mantêm os registros do Zoho alinhados."
            }
          },
          {
            "@type": "Question",
          ...
          {
            "@type": "Question",
            "name": "Quais objetos do Zoho posso associar às conversas do WhatsApp?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "A maioria das equipes associa conversas do WhatsApp a contatos e negócios para rastrear o contexto através do pipeline de vendas. O melhor mapeamento depende do seu fluxo de trabalho do Zoho."
            }
          }
        ]
      }
      ...
      const webpageSchema = {
        ...
        "@type": "WebPage",
        "url": "https://eazybe.com/br/zoho-whatsapp-integration",
        "name": "Zoho WhatsApp Integration e agentes de IA - Eazybe",
      ...
      const softwareApplicationSchema = {
        ...
        "featureList": [
          "Sincronização automática do WhatsApp para o Zoho",
      ...
      const productSchema = {
        ...
        "url": "https://eazybe.com/br/zoho-whatsapp-integration",
        "image": ["https://eazybe.com/logo.png"],
        "description": "A Eazybe conecta WhatsApp com o Zoho CRM para sincronizar chats automaticamente, ajudar equipes de vendas a responder mais rápido com IA e gerenciar conversas do cliente com fluxos de trabalho de caixa de entrada compartilhada.",
      ...
      const howToSchema = {
        "@context": "https://schema.org",
        "@type": "HowTo",
        "name": "Como conectar WhatsApp ao Zoho CRM usando o Eazybe",
        "description": "Siga estes passos para instalar o Eazybe e sincronizar conversas do WhatsApp com o Zoho CRM para que sua equipe possa rastrear chats, acelerar follow-ups e manter registros do CRM atualizados.",
        "totalTime": "PT5M",
        "estimatedCost": { "@type": "MonetaryAmount", "currency": "BRL", "value": "0" },
        "supply": [
          { "@type": "HowToSupply", "name": "Conta Zoho ativa" },
        ...
        "step": [
          ...
          },
          {
            ...
            "name": "Conecte sua conta do Zoho",
            "text": "No painel Eazybe, escolha Zoho e complete o fluxo de autorização para conectar seu CRM com segurança.",
            "image": "https://eazybe.com/logo.png"
          },
          {
            "@type": "HowToStep",
            "url": "https://eazybe.com/br/zoho-whatsapp-integration#step4",
            "name": "Ative a sincronização de chat para o Zoho",
            "text": "Selecione um contato ou conversa e ative a sincronização. As mensagens do WhatsApp e o contexto do cliente começarão a sincronizar para o Zoho automaticamente.",
            "image": "https://eazybe.com/logo.png"
          },
          {
            "@type": "HowToStep",
      ...
      addJsonLdSchema(faqSchema, 'faq-zoho-br')
      addJsonLdSchema(organizationSchema, 'organization-zoho-br')
      addJsonLdSchema(breadcrumbSchema, 'breadcrumb-zoho-br')
      addJsonLdSchema(webpageSchema, 'webpage-zoho-br')
      addJsonLdSchema(softwareApplicationSchema, 'software-zoho-br')
      addJsonLdSchema(productSchema, 'product-zoho-br')
      addJsonLdSchema(howToSchema, 'howto-zoho-br')

      // Cleanup function - remove schemas when leaving the page
      return () => {
        const faqScript = document.querySelector('script[type="application/ld+json"][data-schema="faq-zoho-br"]')
        if (faqScript) faqScript.remove()
        const orgScript = document.querySelector('script[type="application/ld+json"][data-schema="organization-zoho-br"]')
        if (orgScript) orgScript.remove()
        const breadcrumbScript = document.querySelector('script[type="application/ld+json"][data-schema="breadcrumb-zoho-br"]')
        if (breadcrumbScript) breadcrumbScript.remove()
        const webpageScript = document.querySelector('script[type="application/ld+json"][data-schema="webpage-zoho-br"]')
        if (webpageScript) webpageScript.remove()
        const softwareAppScript = document.querySelector('script[type="application/ld+json"][data-schema="software-zoho-br"]')
        if (softwareAppScript) softwareAppScript.remove()
        const productScript = document.querySelector('script[type="application/ld+json"][data-schema="product-zoho-br"]')
        if (productScript) productScript.remove()
        const howToScript = document.querySelector('script[type="application/ld+json"][data-schema="howto-zoho-br"]')
