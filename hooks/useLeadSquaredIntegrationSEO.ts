    ...
    if (isLeadSquaredPage) {
      ...
      const faqSchema = {
        ...
        "mainEntity": [
          ...
          {
            "@type": "Question",
            "name": "How long does it take to set up the LeadSquared WhatsApp integration?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Most teams complete the setup in under 5 minutes. Simply install Eazybe, connect your LeadSquared account, and start syncing WhatsApp conversations."
            }
          },
          {
            "@type": "Question",
            "name": "Can I use WhatsApp Business API with LeadSquared?",
            "acceptedAnswer": {
              "@type": "Answer",
